...
const response_entity_1 = require("../modules/response/entities/response.entity");
const survey_entity_1 = require("../modules/survey/entities/survey.entity");
...
exports.ResponseModule = ResponseModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([response_entity_1.Response, survey_entity_1.Survey, user_entity_1.User]),
        ],
